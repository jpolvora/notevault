    ...
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.container} onClick={(e) => e.stopPropagation()}>
        <div className={styles.sidebar}>
          ...
          <nav>
            <button
              className={activeSection === "editor" ? styles.active : ""}
            ...
            <button
              className={activeSection === "behavior" ? styles.active : ""}
              onClick={() => setActiveSection("behavior")}
            >
              Behavior
            </button>
            <button
              className={activeSection === "auto-save" ? styles.active : ""}
              onClick={() => setActiveSection("auto-save")}
            >
              Auto-Save
            </button>
            <button
              className={activeSection === "encryption" ? styles.active : ""}
              onClick={() => setActiveSection("encryption")}
            >
              Encryption
            </button>
            <button
              className={activeSection === "sync" ? styles.active : ""}
              onClick={() => setActiveSection("sync")}
            >
              Sync
            </button>
            <button
              className={activeSection === "startup" ? styles.active : ""}
              onClick={() => setActiveSection("startup")}
            >
              Startup
            </button>
            <button
              className={activeSection === "shortcuts" ? styles.active : ""}
