...
NoteVault development is structured into incremental **Phases** (1.1, 2.0, etc.). Each phase is documented in its own `.md` file in the `specs/` directory (e.g., `specs/phase5.md`).

- Before starting a new task, the agent reads the relevant `specs/phaseX.md` file.
